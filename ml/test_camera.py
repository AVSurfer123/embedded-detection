...
if __name__ == "__main__":
    ...
    while True:
        ...
        # sample_rate = reduce frequency that data is being saved to file; use to sync w/ alternative labelling frequency
        # sample_rate == -1 --> continuous sampling/writing; not intended (currently, filepath will break)
        if sample_rate == -1 or (sample_rate >= 1 and sec % sample_rate == 0):
            filepath = write_path + "camera/" + timestamp + ".npy"
